  ...
  return (
    <section ref={ref} className="section-padding">
      <div className="container-custom mx-auto">
        <div
          className={`relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-primary-700 to-emerald-800 p-10 sm:p-16 text-center transition-all duration-700 ${
        ...
        >
          ...
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-emerald-400/10 rounded-full translate-x-1/3 translate-y-1/3 blur-2xl" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="https://wa.me/27616691317?text=Hi%20K2%20Web%20Design%2C%20I%27d%20like%20a%20free%20website%20demo!"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-primary-700 font-semibold rounded-xl
                         transition-all duration-300 hover:bg-emerald-50 hover:shadow-lg hover:shadow-black/20
